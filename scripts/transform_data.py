...
with open('data/raw/customer_dirty_data.csv', 'r', encoding='utf-8') as customer_csv:
...
df["review_info_score"] = pd.to_numeric(df["review_info_score"], errors="coerce")
df["review_info_reviews"] = pd.to_numeric(df["review_info_reviews"], errors="coerce")
